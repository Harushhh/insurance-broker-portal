...
web: python manage.py createcachetable; gunicorn project.wsgi --workers 2 --threads 4 --worker-class gthread --timeout 60 --max-requests 500 --max-requests-jitter 50
